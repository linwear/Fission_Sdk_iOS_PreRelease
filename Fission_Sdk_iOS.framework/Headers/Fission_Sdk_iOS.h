...
/*
  ...
  修改记录｜Modification Record:
     project    2024-12-07  Version:3.2.6 Build:20241207001
                            1.⚠️Fission_Sdk_iOS.framework最低系统版本要求 iOS13.0及以上
                            2.⚠️新增Framework库依赖:
                                RTKAudioStreaming.xcframework
                                RTKRealChatConnection.xcframework
                            3.FBFirmwareVersionObject 新增标志位:
                                是否支持音量增益补偿
                            4.新增"设置音量增益补偿"协议（FBAtCommand）fbSetVolumeGainData:withBlock:
                            5.星历文件支持合成包同步
                            6.支持双精度经纬度
                            7.支持瑞昱8773 AI功能（当前只支持chat）
                            8.修复视频转码失败问题
                            9.新增"GPS运动参数设定 (兼容运动定位记录数据双精度)"（FBAtCommand）fbSettingsGPSSportsParameterWithBlock:
