...
#ifndef FISSION_SDK_IOS_SWIFT_H
#define FISSION_SDK_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Fission_Sdk_iOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// 压缩
- (NSData * _Nullable)hsCompressWithImg:(UIImage * _Nonnull)image imgId:(NSInteger)imgId SWIFT_WARN_UNUSED_RESULT;
/// 解压
- (UIImage * _Nullable)hsDeCompressWithPath:(NSString * _Nonnull)filePath imgId:(uint32_t)imgId SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC15Fission_Sdk_iOS13RTKChatObject")
@interface RTKChatObject : NSObject
/// 连接设备
- (void)rtkConnectedWithPeripheral:(CBPeripheral * _Nonnull)peripheral;
/// 断开设备
- (void)rtkDisconnect;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)observeValueForKeyPath:(NSString * _Nullable)keyPath ofObject:(id _Nullable)object change:(NSDictionary<NSKeyValueChangeKey, id> * _Nullable)change context:(void * _Nullable)context;
- (void)setAudioTransmissionStartHandlerWithBlock:(void (^ _Nonnull)(void))block;
- (void)setAudioTransmissionDataHandlerWithBlock:(void (^ _Nonnull)(NSURL * _Nullable))block;
- (void)setAudioTransmissionEndHandlerWithBlock:(void (^ _Nonnull)(NSInteger))block;
/// 发送问题文字到手表的回调
@property (nonatomic, copy) void (^ _Nullable rtkOnRecognizedHandler)(NSString * _Nonnull);
/// 发送答案文字到手表的回调
@property (nonatomic, copy) void (^ _Nullable rtkOnReplyTextHandle)(NSString * _Nonnull);
/// 发送答案文字语音文件到手表的回调
@property (nonatomic, copy) void (^ _Nullable rtkOnReplySpeechHandler)(NSURL * _Nonnull);
@end

@class RTKProfileConnectionManager;

@interface RTKChatObject (SWIFT_EXTENSION(Fission_Sdk_iOS)) <RTKProfileConnectionManagerDelegate>
- (void)profileManagerDidUpdateGATTAvailability:(RTKProfileConnectionManager * _Nonnull)manager;
@end


@interface UIImage (SWIFT_EXTENSION(Fission_Sdk_iOS))
///      缩放并裁剪至指定大小，并做圆角处理
///      
- (UIImage * _Nullable)hsScaleAndCropImageToSize:(CGSize)size cornerRadius:(CGFloat)cornerRadius SWIFT_WARN_UNUSED_RESULT;
@end
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("Fission_Sdk_iOS", usrValue)
...
// Unavailable in C++: Swift type alias 'RTKChatObjectAudioTransmissionDataHandler'.

// Unavailable in C++: Swift type alias 'RTKChatObjectAudioTransmissionEndHandler'.

// Unavailable in C++: Swift type alias 'RTKChatObjectAudioTransmissionStartHandler'.

// Unavailable in C++: Swift type alias 'RTKChatObjectOnRecognizedHandler'.

// Unavailable in C++: Swift type alias 'RTKChatObjectOnReplySpeechHandler'.

// Unavailable in C++: Swift type alias 'RTKChatObjectOnReplyTextHandler'.
