...
/**
 ...
 @param items                                 自定义的选项｜Customized options
 @return                    YES溢出，NO正常｜YES overflow, NO normal
*/
+ (BOOL)checkForOverflow:(NSArray <FBCustomDialItem *> *)items;


/**
 单个组件中的控件数量｜Number of controls in a single component
 @param item                                 自定义的选项｜Customized options
 @return                   控件的数量｜Number of controls
 */
+ (int)numberOfControlsInSingleItem:(FBCustomDialItem *)item;


/**
 所有组件中的控件数量｜Number of controls in all components
 @param items                               自定义的选项｜Customized options
 @return                   控件的数量｜Number of controls
 */
+ (int)numberOfControlsInAllItems:(NSArray <FBCustomDialItem *> *)items;


/**
 生成多项目自定义表盘bin文件数据 | Generate multi project custom dial bin file data
